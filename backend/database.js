...
function seed() {
  ...
  try {
    ...
    iU.run('u8','Isabella Mendoza','isabella.m@email.com','+63 924 890 1234',h('password123'),'landlord','IM','https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop&crop=face&q=80',null,null,'{}',0,0,0,0,'2025-12-15');
    ...
    iA.run('app2','u2','p3','u3','Pending','Interested in the 1BR condo.',now,now);
